...
export default function AccountManagement() {
  ...
  const handleExportData = async () => {
    ...
    setExporting(true);
    try {
      const [ordersRes, transactionsRes, profileRes, ticketsRes] = await Promise.all([
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="glass rounded-2xl p-6 space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Download a copy of all your data including profile, orders, transactions, and support tickets in JSON format.
      ...
      <div className="glass rounded-2xl p-6 space-y-4 border border-destructive/20">
        <h3 className="font-heading font-semibold flex items-center gap-2 text-destructive">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground">
                Deleting your account will permanently remove all your data, including orders, wallet balance, and support history.
                Any remaining wallet balance will be forfeited. This action complies with GDPR right to erasure.
              </p>
            </div>
          </div>
        </div>
