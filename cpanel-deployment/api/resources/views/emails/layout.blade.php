...
<head>
    ...
    <title>{{ $subject ?? config('app.name', 'emazingSM') }}</title>
    <style>
...
<body>
    <div class="email-container">
        <div class="email-card">
            <div class="email-header">{{ config('app.name', 'emazingSM') }}</div>
            <div class="email-body">
                {!! $body !!}
            </div>
        </div>
        <div class="email-footer">
            <p class="small">You are receiving this email because you have an account with {{ config('app.name', 'emazingSM') }}.</p>
            <p class="small"><a href="{{ config('app.url') }}">{{ config('app.url') }}</a></p>
        </div>
    </div>
</body>
</html>
